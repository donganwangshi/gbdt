...
import org.apache.spark.mllib.tree.impurity.Impurity_new
 ...
 */
private[tree] class DecisionTreeMetadata_new(
    val numFeatures: Int,
...
private[tree] object DecisionTreeMetadata_new extends Logging {
  ...
  def buildMetadata(
      ...
      numTrees: Int,
      featureSubsetStrategy: String): DecisionTreeMetadata_new = {
    ...
    new DecisionTreeMetadata_new(numFeatures, numExamples, numClasses, numBins.max,
  ...
  def buildMetadata(
      input: RDD[LabeledPoint],
      strategy: Strategy_new): DecisionTreeMetadata_new = {
