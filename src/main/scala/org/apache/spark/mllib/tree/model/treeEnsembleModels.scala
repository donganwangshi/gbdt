 ...
 */
@Experimental
class RandomForestModel(override val algo: Algo, override val trees: Array[DecisionTreeModel_new])
...
class GradientBoostedTreesModel(
    ...
    override val trees: Array[DecisionTreeModel_new],
...
private[tree] sealed class TreeEnsembleModel(
    ...
    protected val trees: Array[DecisionTreeModel_new],
